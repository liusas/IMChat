...
@property (nonatomic, copy) NSArray *photos;/**< 图片数组*/
...
- (void)showByLastViewController:(nonnull UIViewController *)viewController andPhotos:(nonnull NSArray<LFPhoto *> *)photos {
    self.photos = photos;
...
- (__kindof UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    LFPhoto *photo = self.photos[indexPath.item];
    [cell setImageWithUrl:[NSURL URLWithString:photo.hightQuality] placeholderImage:photo.thumbnailImage];
